                        ...
                        <div className="project__wrapper">
                            ...
                            <div className="project__description">
                                ...
                                <p className="project__description--para">
                                    Learned from Avinash to create a Spotify
                                    clone app, using a static database, using
                                    TailwindCSS for the first time. Users can
                                    sample a limited number of audio files,
                                    grouped under a few psuedo albums where they
                                    can play/pause/skip back & forth/slide
