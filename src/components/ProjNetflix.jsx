                        ...
                        <div className="project__wrapper">
                            ...
                            <div className="project__description">
                                ...
                                <p className="project__description--para">
                                    Using a static data file of limited movies
                                    resource, learned from Avinash to create a
                                    user authentication dialogue linked to
                                    Firestore and upon successful registration /
                                    sign in, user gets to browse the database,
                                    grouped under a variety of categories, and
                                    watch trailers available.
                                </p>
